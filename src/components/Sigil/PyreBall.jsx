  ...
  return (
    <>
      <svg className={styling} id="pyreball" viewBox="0 0 99.494102 99.494118" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
        <defs id="defs1" />
        <circle id="l3__container" cx="49.747055" cy="49.747051" r="48.873589" className="stroke" />
        <g id="l3__arrow-1" transform="translate(-60.28309,-65.179056)">
        ...
        <g id="m3__center" transform="translate(-60.28309,-65.179056)">
        ...
        <g id="l3__arrow-2" transform="matrix(-1,0,0,1,159.72262,-64.996848)">
        ...
        <g id="l3__arrow-3" transform="rotate(180,79.952415,82.292982)">
        ...
        <g id="l3__arrow-4" transform="matrix(1,0,0,-1,-60.283085,164.76817)">
